package com.dad.jokes.service;

import com.dad.jokes.exception.ResourceNotFoundException;
...
public class UserServiceImpl implements UserDetailsService, UserService
{
    ...
    public UserServiceImpl(UserRepository userrepos, RoleRepository rolerepos)
    {
    ...
    public List<com.dad.jokes.model.User> findAll()
    {
